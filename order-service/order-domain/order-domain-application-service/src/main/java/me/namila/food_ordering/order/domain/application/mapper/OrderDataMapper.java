package me.namila.food_ordering.order.domain.application.mapper;
...
import me.namila.food_ordering.order.domain.application.dto.create.OrderAddress;
import me.namila.food_ordering.order.domain.application.dto.create.OrderItem;
import me.namila.food_ordering.order.domain.application.dto.track.TrackOrderResponse;
...
public class OrderDataMapper {
  ...
  private List<me.namila.food_ordering.order.domain.core.entity.OrderItem> orderItemToOrderItemEntities(
      @NonNull List<OrderItem> items) {
    return items.stream()
        .map(orderItem -> me.namila.food_ordering.order.domain.core.entity.OrderItem.Builder
            .builder()
