package me.namila.food_ordering.order.messaging.mapper;
...
public abstract class OrderMessagingDataMapper {
  ...
  protected abstract PaymentStatus convertOrderStatusToRestaurantStatus(
  ...
  protected abstract OrderApprovalStatus convertOrderStatusAvroToorderApprovalStatus(
