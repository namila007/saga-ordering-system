package me.namila.food_ordering.dataaccess.restaurant.adapter;
...
import me.namila.food_ordering.dataaccess.restaurant.mapper.RestaurantDataAccessMapper;
import me.namila.food_ordering.dataaccess.restaurant.repository.RestaurantJpaRepository;
...
public class RestaurantRepositoryImpl implements RestaurantRepository {
  ...
  public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
    ...
    Optional<List<RestaurantEntity>> restaurantEntityList =
        restaurantJpaRepository.findByRestaurantEntityId(restaurantEntityIdList);
