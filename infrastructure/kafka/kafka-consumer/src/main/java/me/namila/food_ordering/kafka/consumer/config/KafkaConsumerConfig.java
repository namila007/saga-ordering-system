package me.namila.food_ordering.kafka.consumer.config;
...
import me.namila.food_ordering.kafka.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
  ...
  public Map<String, Object> consumerConfigs() {
    ...
    props.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG,
        kafkaConsumerConfigData.getMaxPartitionFetchByteDefault()
            * kafkaConsumerConfigData.getMaxPartitionFetchByteBoostFactor());
